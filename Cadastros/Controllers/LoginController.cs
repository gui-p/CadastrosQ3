...
namespace Cadastros.Controllers
{
    public class LoginController : Controller
    {
        ...
        private readonly ILoginRepositorio _repo;

        public LoginController(ILoginRepositorio loginRepositorio)
        {
            _repo = loginRepositorio;
        }
        ...
        {
            LoginModel loginDB = await _repo.ListarPorUsuario(usuario);
            var sucesso = false;
		...
		{
			LoginModel login = await _repo.ListarPorId(id);
		...
		{
			LoginModel loginDB = await _repo.ListarPorId(login.Id);
